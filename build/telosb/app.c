...
extern int memcmp(const void *arg_0x2ae95517cde8, const void *arg_0x2ae95517b100, size_t arg_0x2ae95517b3a8);
extern void *memcpy(void *arg_0x2ae95517bbf0, const void *arg_0x2ae955181020, size_t arg_0x2ae9551812c8);

extern void *memset(void *arg_0x2ae955180980, int arg_0x2ae955180be8, size_t arg_0x2ae95517f020);
#line 61
extern void *memset(void *arg_0x2ae955199b10, int arg_0x2ae955199d78, size_t arg_0x2ae955198060);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x2ae9551da290);
  ...
  void (**_sig_func)(int arg_0x2ae9551df300);
...
typedef nx_struct lab3 {
  nx_uint8_t source;
  nx_uint8_t generation;
  nx_uint8_t type;
  nx_uint8_t bid;
  nx_uint8_t winner;
} __attribute__((packed)) lab3_t;
...
typedef TMilli Lab3C__SerialTimer__precision_tag;
typedef TMilli Lab3C__Timer__precision_tag;
...
static void Lab3C__Boot__booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void Lab3C__AMSend__sendDone(
#line 103
message_t * msg, 
...
static void Lab3C__RadioControl__startDone(error_t error);
#line 138
static void Lab3C__RadioControl__stopDone(error_t error);
#line 113
static void Lab3C__SerialControl__startDone(error_t error);
#line 138
static void Lab3C__SerialControl__stopDone(error_t error);
...
static void Lab3C__SerialTimer__fired(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void Lab3C__serialSendTask__runTask(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void Lab3C__SerialAMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Lab3C__Timer__fired(void );
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
/*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(
#line 132
message_t * msg, 
...
uint8_t len);
#line 123
static uint8_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__maxPayloadLength(void );
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
/*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(
#line 132
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t Lab3C__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 123
static uint8_t Lab3C__AMSend__maxPayloadLength(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Lab3C__RadioControl__start(void );
#line 104
static error_t Lab3C__SerialControl__start(void );
# 134 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void Lab3C__Leds__set(uint8_t val);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Lab3C__SerialTimer__startPeriodic(uint32_t dt);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t Lab3C__serialSendTask__postTask(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t Lab3C__SerialAMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
Lab3C__SerialAMSend__getPayload(
#line 132
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Lab3C__Timer__startOneShot(uint32_t dt);
# 308 "Lab3C.nc"
enum Lab3C____nesc_unnamed4310 {
#line 308
  Lab3C__serialSendTask = 0U
};
#line 308
typedef int Lab3C____nesc_sillytask_serialSendTask[Lab3C__serialSendTask];
#line 26
message_t Lab3C__sendBuf;
bool Lab3C__sendBusy;

lab3_t Lab3C__local;

uint8_t Lab3C__master;
uint8_t Lab3C__first_bid = 0;
uint8_t Lab3C__first_source = 0;
uint8_t Lab3C__random0to5 = 0;
uint16_t Lab3C__motebid[3];



message_t Lab3C__serialSendBuf;
bool Lab3C__serialSendBusy;


oscilloscope_t Lab3C__serialLocal[3];

uint8_t Lab3C__reading;
...
bool Lab3C__suppressCountChange;

int Lab3C__serialPacketsRemaining = 0;


static inline void Lab3C__Boot__booted(void );
#line 85
static inline void Lab3C__startTimer(void );
...
static void Lab3C__sendLocal(void );
...
static inline void Lab3C__RadioControl__startDone(error_t error);
...
static inline void Lab3C__RadioControl__stopDone(error_t error);



static void Lab3C__serialStartTimer(void );




static inline void Lab3C__SerialControl__startDone(error_t error);



static inline void Lab3C__SerialControl__stopDone(error_t error);



static inline message_t *Lab3C__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 262
static inline void Lab3C__Timer__fired(void );
#line 301
static inline void Lab3C__AMSend__sendDone(message_t *msg, error_t error);
...
static inline void Lab3C__serialSendTask__runTask(void );
#line 320
static inline message_t *Lab3C__SerialReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 350
static inline void Lab3C__SerialTimer__fired(void );
#line 379
static inline void Lab3C__SerialAMSend__sendDone(message_t *msg, error_t error);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
message_t *msg);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
/*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(
#line 122
message_t * msg, 
...
uint8_t len);
#line 112
static uint8_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__maxPayloadLength(void );
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static inline error_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);



static inline uint8_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__maxPayloadLength(void );



static inline void */*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(message_t *m, uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
/*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(
#line 122
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static inline error_t /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
static inline void */*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(message_t *m, uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x2ae95587a458){
#line 39
  switch (arg_0x2ae95587a458) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x2ae95587a458);
#line 39
      break;
#line 39
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x2ae956920d60, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x2ae956920d60, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x2ae9560f1be8){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0x2ae9560f1be8) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x2ae9560f1be8);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x2ae9560f0e18){
#line 39
  union __nesc_unnamed4281 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x2ae9560f0e18);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2ae9562c89b8){
#line 59
  switch (arg_0x2ae9562c89b8) {
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x2ae9562c89b8);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x2ae9562cb7e8){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x2ae9562cb7e8);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x2ae9560f1be8){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x2ae9560f1be8);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2ae9562cb7e8){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x2ae9562cb7e8);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x2ae9560f1be8){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x2ae9560f1be8);
#line 88
      break;
#line 88
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2ae9562c89b8){
#line 65
  switch (arg_0x2ae9562c89b8) {
#line 65
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2ae9562c89b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x2ae9560f1be8){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x2ae9560f1be8);
#line 120
      break;
#line 120
    }
...
#line 65
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t Lab3C__serialSendTask__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(Lab3C__serialSendTask);
#line 67
...
#line 379
{
  Lab3C__serialSendBusy = FALSE;
  if (Lab3C__serialPacketsRemaining) {
      Lab3C__serialSendTask__postTask();
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  Lab3C__SerialAMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x2ae9569f8788, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ae9569f8788) {
#line 100
    case 0U:
#line 100
      /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x2ae9569f8788, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x2ae9569f7960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x2ae9569f7960, addr, msg, len);
#line 80
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2ae956b4e308, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x2ae956b4e308) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2ae956b4e308, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2ae956b4e308){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2ae956b4e308);
#line 15
      break;
#line 15
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x2ae956bf47e8){
#line 102
  switch (arg_0x2ae956bf47e8) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x2ae956bf47e8);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x2ae9562cc640){
#line 102
  switch (arg_0x2ae9562cc640) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x2ae9562cc640);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x2ae9562c89b8){
#line 59
  switch (arg_0x2ae9562c89b8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x2ae9562c89b8);
#line 59
      break;
#line 59
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x2ae956beecd0){
#line 39
  union __nesc_unnamed4285 *__nesc_result;
#line 39

#line 39
  switch (arg_0x2ae956beecd0) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x2ae956beecd0);
#line 39
      break;
#line 39
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2ae956a59820, message_t * msg, error_t error){
#line 110
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x2ae956a59820, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2ae956b4f020, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ae956b4f020) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2ae956b4f020, msg, error);
#line 100
      break;
#line 100
    }
...
#line 320
{
  ...
  if (__nesc_ntoh_uint16(omsg->version.nxdata) > __nesc_ntoh_uint16(Lab3C__serialLocal[0].version.nxdata)) 
    {
      for (i = 0; i <= 2; i++) {
          __nesc_hton_uint16(Lab3C__serialLocal[i].version.nxdata, __nesc_ntoh_uint16(omsg->version.nxdata));
          __nesc_hton_uint16(Lab3C__serialLocal[i].interval.nxdata, __nesc_ntoh_uint16(omsg->interval.nxdata));
        }
      Lab3C__serialStartTimer();
    }
  if (__nesc_ntoh_uint16(omsg->count.nxdata) > __nesc_ntoh_uint16(Lab3C__serialLocal[0].count.nxdata)) 
    {
      for (i = 0; i <= 2; i++) {
          __nesc_hton_uint16(Lab3C__serialLocal[i].count.nxdata, __nesc_ntoh_uint16(omsg->count.nxdata));
        }
      Lab3C__suppressCountChange = TRUE;
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2ae956a58a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ae956a58a90) {
#line 78
    case 147:
#line 78
      __nesc_result = Lab3C__SerialReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2ae956a58a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2ae956b503e0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ae956b503e0) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2ae956b503e0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2ae956b4e308, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2ae956b4e308, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void Lab3C__SerialTimer__startPeriodic(uint32_t dt){
#line 64
...
#line 138
  Lab3C__SerialControl__stopDone(error);
#line 138
}
#line 138
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x2ae9562c89b8){
#line 65
  switch (arg_0x2ae9562c89b8) {
#line 65
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x2ae9562c89b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x2ae956befa20){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x2ae956befa20) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x2ae956befa20);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x2ae956befa20){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x2ae956befa20);
#line 128
      break;
#line 128
    }
...
#line 113
  Lab3C__SerialControl__startDone(error);
#line 113
}
#line 113
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x2ae9562cb7e8){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x2ae9562cb7e8);
#line 61
}
#line 61
# 93 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x2ae956befa20){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x2ae956befa20);
#line 97
      break;
#line 97
    }
...
#line 301
{
  Lab3C__sendBusy = FALSE;
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  Lab3C__AMSend__sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2ae9569f8788, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ae9569f8788) {
#line 100
    case 0U:
#line 100
      /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2ae9569f8788, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2ae9569f7960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x2ae9569f7960, addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x2ae956920258, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x2ae956920258, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x2ae956920d60, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x2ae956920d60, msg);
#line 95
}
#line 95
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x2ae956883280){
#line 102
  switch (arg_0x2ae956883280) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x2ae956883280);
#line 102
      break;
#line 102
    }
...
# 134 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void Lab3C__Leds__set(uint8_t val){
#line 134
...
#line 265
  if (Lab3C__master == TOS_NODE_ID) {
      ...
      if (__nesc_ntoh_uint8(Lab3C__local.type.nxdata) == AWARD) {



          Lab3C__first_source = 0;
          Lab3C__first_bid = 0;
          Lab3C__master = __nesc_ntoh_uint8(Lab3C__local.winner.nxdata);
          (__nesc_temp44 = Lab3C__local.generation.nxdata, __nesc_hton_uint8(__nesc_temp44, (__nesc_temp45 = __nesc_ntoh_uint8(__nesc_temp44)) + 1), __nesc_temp45);
          __nesc_hton_uint8(Lab3C__local.type.nxdata, BID);
          __nesc_hton_uint8(Lab3C__local.bid.nxdata, 0);
          Lab3C__motebid[TOS_NODE_ID - 1] = 0;
        }
    }
  else {

      if (__nesc_ntoh_uint8(Lab3C__local.type.nxdata) == BID) {



          Lab3C__sendLocal();
          __nesc_hton_uint8(Lab3C__local.type.nxdata, AWARD);
        }
    }
}
...
#line 351
  ...
  if (Lab3C__reading == NREADINGS) {
      if (!Lab3C__serialSendBusy) {
          Lab3C__serialPacketsRemaining = 3;
          Lab3C__serialSendTask__postTask();

          Lab3C__reading = 0;


          if (!Lab3C__suppressCountChange) {
              for (i = 0; i <= 2; i++) {
                  (__nesc_temp46 = Lab3C__serialLocal[i].count.nxdata, __nesc_hton_uint16(__nesc_temp46, (__nesc_temp47 = __nesc_ntoh_uint16(__nesc_temp46)) + 1), __nesc_temp47);
                }
            }
          Lab3C__suppressCountChange = FALSE;
        }
    }
  ...
  if (Lab3C__reading < NREADINGS) {
      Lab3C__reading++;
      for (i = 0; i <= 2; i++) {
          __nesc_hton_uint16(Lab3C__serialLocal[i].readings[Lab3C__reading].nxdata, Lab3C__motebid[i]);
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2ae9567595d8){
#line 83
  switch (arg_0x2ae9567595d8) {
#line 83
    case 1U:
#line 83
      Lab3C__Timer__fired();
...
#line 83
    case 2U:
#line 83
      Lab3C__SerialTimer__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2ae9567595d8);
#line 83
      break;
#line 83
    }
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__maxPayloadLength(am_id_t arg_0x2ae9569f7960){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = CC2420ActiveMessageP__AMSend__maxPayloadLength(arg_0x2ae9569f7960);
#line 123
...
# 112 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static uint8_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__maxPayloadLength(void ){
#line 112
  unsigned char __nesc_result;
#line 112
...
#line 69
{
  return /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__maxPayloadLength();
}

# 123 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static uint8_t Lab3C__AMSend__maxPayloadLength(void ){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__maxPayloadLength();
#line 123
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__getPayload(am_id_t arg_0x2ae9569f7960, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(arg_0x2ae9569f7960, msg, len);
#line 135
...
# 125 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void * /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(message_t * msg, uint8_t len){
#line 125
  void *__nesc_result;
#line 125
...
#line 73
{
  return /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__getPayload(m, len);
}

# 135 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void * Lab3C__AMSend__getPayload(message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__getPayload(msg, len);
#line 135
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 89);
  return /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Lab3C__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*Lab3AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x2ae956923480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x2ae956923480, msg, payload, len);
#line 78
...
#line 78
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void Lab3C__Timer__startOneShot(uint32_t dt){
#line 73
...
#line 85
{
  ...
  Lab3C__Leds__set(__nesc_ntoh_uint8(Lab3C__local.bid.nxdata));
  Lab3C__Timer__startOneShot(LED_INTERVAL);
}
...
#line 130
  ...
  Lab3C__motebid[__nesc_ntoh_uint8(l3msg->source.nxdata) - 1] = __nesc_ntoh_uint8(l3msg->bid.nxdata);
  ...
  if (Lab3C__master == TOS_NODE_ID) {
      ...
      if (__nesc_ntoh_uint8(Lab3C__local.generation.nxdata) != __nesc_ntoh_uint8(l3msg->generation.nxdata)) {
      ...
      if (!Lab3C__first_bid && !Lab3C__first_source) {


          Lab3C__first_bid = __nesc_ntoh_uint8(l3msg->bid.nxdata);
          Lab3C__first_source = __nesc_ntoh_uint8(l3msg->source.nxdata);
          Lab3C__motebid[__nesc_ntoh_uint8(l3msg->source.nxdata) - 1] = __nesc_ntoh_uint8(l3msg->bid.nxdata);
        }
      else 
...

        {
          ...
          if (__nesc_ntoh_uint8(l3msg->source.nxdata) != Lab3C__first_source) {
              ...
              if (__nesc_ntoh_uint8(l3msg->bid.nxdata) <= Lab3C__first_bid) {

                  __nesc_hton_uint8(Lab3C__local.bid.nxdata, Lab3C__first_bid);
                  __nesc_hton_uint8(Lab3C__local.winner.nxdata, Lab3C__first_source);
                }
              else 

                {

                  __nesc_hton_uint8(Lab3C__local.bid.nxdata, __nesc_ntoh_uint8(l3msg->bid.nxdata));
                  __nesc_hton_uint8(Lab3C__local.winner.nxdata, __nesc_ntoh_uint8(l3msg->source.nxdata));
                }
      ...
      if (__nesc_ntoh_uint8(l3msg->source.nxdata) != Lab3C__master) {
      ...
      if (__nesc_ntoh_uint8(l3msg->generation.nxdata) > __nesc_ntoh_uint8(Lab3C__local.generation.nxdata)) {


          __nesc_hton_uint8(Lab3C__local.generation.nxdata, __nesc_ntoh_uint8(l3msg->generation.nxdata));
        }

      if (__nesc_ntoh_uint8(Lab3C__local.type.nxdata) == BID) {


          Lab3C__random0to5 = rand();

          __nesc_hton_uint8(Lab3C__local.bid.nxdata, 1 + Lab3C__random0to5 % 6);


          Lab3C__motebid[TOS_NODE_ID - 1] = __nesc_ntoh_uint8(Lab3C__local.bid.nxdata);
          Lab3C__startTimer();
        }
      else {
          ...
          Lab3C__Leds__set(0);
          (__nesc_temp42 = Lab3C__local.generation.nxdata, __nesc_hton_uint8(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint8(__nesc_temp42)) + 1), __nesc_temp43);
          __nesc_hton_uint8(Lab3C__local.type.nxdata, BID);


          if (__nesc_ntoh_uint8(l3msg->winner.nxdata) == TOS_NODE_ID) {




              Lab3C__master = TOS_NODE_ID;
              __nesc_hton_uint8(Lab3C__local.bid.nxdata, 7);
              Lab3C__motebid[TOS_NODE_ID - 1] = 7;
              Lab3C__startTimer();
            }
          else {
              ...
              Lab3C__master = __nesc_ntoh_uint8(l3msg->winner.nxdata);
              __nesc_hton_uint8(Lab3C__local.bid.nxdata, 0);
              Lab3C__motebid[TOS_NODE_ID - 1] = 0;
            }
        }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x2ae956924908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ae956924908) {
#line 78
    case 89:
#line 78
      __nesc_result = Lab3C__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x2ae956924908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x2ae9560f9cc0){
#line 102
  switch (arg_0x2ae9560f9cc0) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x2ae9560f9cc0);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x2ae9562cc640){
#line 102
  switch (arg_0x2ae9562cc640) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x2ae9562cc640);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x2ae9560f2e38, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x2ae9560f2e38) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x2ae9560f2e38, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x2ae955fd5328, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x2ae955fd5328) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x2ae955fd5328, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x2ae956920d60, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x2ae956920d60, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x2ae955fd5328, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x2ae955fd5328) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x2ae955fd5328, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x2ae955fd6158){
#line 102
  switch (arg_0x2ae955fd6158) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x2ae955fd6158);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x2ae9569267d8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2ae9569267d8, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  Lab3C__RadioControl__stopDone(error);
#line 138
}
#line 138
...
#line 113
  Lab3C__RadioControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 162 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 147);
  return /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Lab3C__SerialAMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
# 135 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void * /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__getPayload(am_id_t arg_0x2ae9569f7960, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__getPayload(arg_0x2ae9569f7960, msg, len);
#line 135
...
# 125 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void * /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(message_t * msg, uint8_t len){
#line 125
  void *__nesc_result;
#line 125
...
#line 73
{
  return /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(m, len);
}

# 135 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void * Lab3C__SerialAMSend__getPayload(message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = /*Lab3AppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(msg, len);
#line 135
...
#line 308
{
  Lab3C__serialPacketsRemaining--;
  if (!Lab3C__serialSendBusy) 
    {
      memcpy(Lab3C__SerialAMSend__getPayload(&Lab3C__serialSendBuf, sizeof(oscilloscope_t )), &Lab3C__serialLocal[Lab3C__serialPacketsRemaining], sizeof(oscilloscope_t ));
      if (Lab3C__SerialAMSend__send(AM_BROADCAST_ADDR, &Lab3C__serialSendBuf, sizeof(oscilloscope_t )) == SUCCESS) {
          Lab3C__serialSendBusy = TRUE;
        }
    }
}
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Lab3C__SerialControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Lab3C__RadioControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 57
{
  ...
  __nesc_hton_uint8(Lab3C__local.generation.nxdata, 0);
  __nesc_hton_uint8(Lab3C__local.source.nxdata, TOS_NODE_ID);
  __nesc_hton_uint8(Lab3C__local.type.nxdata, BID);
  __nesc_hton_uint8(Lab3C__local.bid.nxdata, 7);
  __nesc_hton_uint8(Lab3C__local.winner.nxdata, 0);
  Lab3C__master = 1;
  ...
  memset(Lab3C__motebid, 0, sizeof Lab3C__motebid);


  for (i = 0; i <= 2; i++) {
      __nesc_hton_uint16(Lab3C__serialLocal[i].interval.nxdata, SERIAL_INTERVAL);
      __nesc_hton_uint16(Lab3C__serialLocal[i].id.nxdata, i + 1);
    }

  Lab3C__Leds__set(0);
  Lab3C__RadioControl__start();
  Lab3C__SerialControl__start();
}
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x2ae956271800, uint8_t data){
#line 54
  switch (arg_0x2ae956271800) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x2ae956271800, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x2ae95626f620){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x2ae95626f620);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x2ae956271800){
#line 49
  switch (arg_0x2ae956271800) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x2ae956271800);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x2ae956bf27e0, uint8_t byte){
#line 79
  switch (arg_0x2ae956bf27e0) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x2ae956bf27e0, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x2ae956bf27e0, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x2ae956bf27e0) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x2ae956bf27e0, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x2ae956271800, uint8_t data){
#line 54
  switch (arg_0x2ae956271800) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x2ae956271800, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x2ae956bf27e0, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x2ae956bf27e0) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x2ae956bf27e0, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x2ae956271800){
#line 49
  switch (arg_0x2ae956271800) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x2ae956271800);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x2ae95587a458){
#line 39
  switch (arg_0x2ae95587a458) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x2ae95587a458);
#line 39
      break;
#line 39
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2ae9556a6650){
#line 75
  switch (arg_0x2ae9556a6650) {
#line 75
    case Lab3C__serialSendTask:
#line 75
      Lab3C__serialSendTask__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2ae9556a6650);
#line 75
      break;
#line 75
    }
...
#line 116
{
  Lab3C__SerialTimer__startPeriodic(__nesc_ntoh_uint16(Lab3C__serialLocal[0].interval.nxdata));
  Lab3C__reading = 0;
}
...
#line 92
{
  ...
  if (!Lab3C__sendBusy && sizeof Lab3C__local <= Lab3C__AMSend__maxPayloadLength()) 
    {
      memcpy(Lab3C__AMSend__getPayload(&Lab3C__sendBuf, sizeof Lab3C__local), &Lab3C__local, sizeof Lab3C__local);
      if (Lab3C__AMSend__send(AM_BROADCAST_ADDR, &Lab3C__sendBuf, sizeof Lab3C__local) == SUCCESS) {
        Lab3C__sendBusy = TRUE;
        }
    }
}
